angular.module('clientApp')
    .controller('CalendarController', ['$scope', '$timeout', '$http', '$resource', '$location', '$routeParams', 'uiCalendarConfig', 'Appointment', '$modal', function ($scope, $timeout, $http, $resource, $location, $routeParams, uiCalendarConfig, Appointment, $modal) {
        var date = new Date();
        var d = date.getDate();
        var m = date.getMonth();
