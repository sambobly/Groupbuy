...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { appointment_id: @letter.appointment_id, content: @letter.content, doctor_id: @letter.doctor_id, patient_id: @letter.patient_id, subject: @letter.subject }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { appointment_id: @letter.appointment_id, content: @letter.content, doctor_id: @letter.doctor_id, patient_id: @letter.patient_id, subject: @letter.subject }
    assert_redirected_to letter_path(assigns(:letter))
  end
