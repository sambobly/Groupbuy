...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { email: @recipient.email, firstName: @recipient.firstName, lastName: @recipient.lastName, letter_id: @recipient.letter_id, name: @recipient.name, type: @recipient.type }
    end
  ...
  test "should update recipient" do
    patch :update, id: @recipient, recipient: { email: @recipient.email, firstName: @recipient.firstName, lastName: @recipient.lastName, letter_id: @recipient.letter_id, name: @recipient.name, type: @recipient.type }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
